...
def main():
    ...
    # Get today as a naive date for comparison
    today = datetime.now(timezone.utc).date()
    
    # Compare using .dt.date accessor to extract just the date part
    df_future = df[df["parsed_date"].dt.date >= today].sort_values("parsed_date")
